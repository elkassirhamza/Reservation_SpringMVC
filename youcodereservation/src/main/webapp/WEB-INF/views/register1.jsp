...
<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    <a class="navbar-brand" href="home1">Admin : <%= request.getSession().getAttribute("prenom") %></a>
        ...
        <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
            <div class="sb-sidenav-menu">
                <div class="nav">
                    ...
                    <a class="nav-link" href="register1.jsp">
                    ...
                    <div class="inner" <%--style="background-image: url('${ pageContext.request.contextPath }/resources/images/registration-form-2.jpg');"--%>>
                        <c:if test="${!(msg == null)}" var="test">
                            <div class="alert alert-success aler" role="alert">
                                <p class="text-success ml-auto"><c:out value="${msg}"></c:out></p>
                            </div>
                        </c:if>
                        <form action="Register1" method="post">
                            ...
                            <button class="btn btn-success" type="submit" value="register">Create Account</button>
